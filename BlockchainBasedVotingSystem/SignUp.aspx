...
<body>  
    ...
    <div id="large-header" class="large-header">
		...
		<div class="form">
			...
			<div class="login">
        <div style="margin: 0 auto; width: 100%;"><img src="images/election-removebg-preview.png" style="text-align: center;" width="100%"></div>
        <div class="half-box">
...
<%--<input class="input1" type="text" name="username">--%>
            ...
            <asp:CompareValidator ID="CompareValidator1"  ForeColor="red" runat="server" ErrorMessage="Password Doesnt match" ControlToValidate="ConfirmPassword" Display="Dynamic" ControlToCompare="passwordtxt"></asp:CompareValidator>
			   ...
			   <div class="btn"><a href="#">
                   <br />
                   <asp:Button ID="Button1" class="button" runat="server" Text="Register" OnClick="Button1_Click"/></a></div>
